...
<body class="min-h-screen bg-white dark:bg-zinc-800">
  <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <flux:navlist.group :heading="__('Event Management')" collapsible class="grid">
      <flux:navlist.item icon="home" :href="route('admin.events.management')" :current="request()->routeIs('admin.events.management')"
      wire:navigate>
      {{ __('Create Event') }}
      </flux:navlist.item>
      <flux:navlist.item icon="home" :href="route('dashboard')" :current="request()->routeIs('tudents.approved')"
      wire:navigate>
      {{ __('All Events') }}
      </flux:navlist.item>
