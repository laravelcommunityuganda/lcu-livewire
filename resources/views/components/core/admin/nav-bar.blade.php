<nav x-data="{ showingNavigationDropdown: false }"
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex dark:text-gray-200">
                    <x-core.nav-link href="{{ route('admin.dashboard') }}"
                        :active="request()->routeIs('admin.dashboard')">
                        Dashboard
                    </x-core.nav-link>
                    <x-core.nav-link href="{{ route('admin.users.index') }}"
                        :active="request()->routeIs('admin.users.index')">
                        Users
                    </x-core.nav-link>
                    <x-core.nav-link href="{{ route('admin.events.index') }}"
                    ...
                    <x-core.nav-link href="{{ route('admin.posts.index') }}"
                        :active="request()->routeIs('admin.posts.index')">
                        Posts
                    </x-core.nav-link>
                    <x-core.nav-link href="{{ route('admin.forums.index') }}"
    ...
    <div x-show="showingNavigationDropdown" x-transition class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-core.responsive-nav-link href="{{ route('admin.dashboard') }}"
                :active="request()->routeIs('admin.dashboard')">
                Home
