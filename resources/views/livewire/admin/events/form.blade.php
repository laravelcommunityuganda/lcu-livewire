    ...
    <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
        ...
        <div class="mb-4 p-4 bg-gray-50 rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <x-select label="Type" wire:model="filters.type" placeholder="All Types" :options="[
                        ...
                        <tr wire:key="event-{{ $event->id }}">
                                ...
                                <div class="flex items-center">
                                    @if($event->image)
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded" src="{{ asset('storage/' . $event->image) }}" alt="">
                                        </div>
                                    @endif
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex space-x-2">
                                    ...
                                    <x-button icon="trash" negative wire:click="deleteConfirmation({{ $event->id }})" />
                                </div>
                            </td>
                        </tr>
                    @endforeach
